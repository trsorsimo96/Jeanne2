...
public class Company implements Serializable {
    ...
    @JsonIgnore
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<Itineraire> bookings = new HashSet<>();
    ...
    @JsonIgnore
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<FeesAgency> configs = new HashSet<>();
    ...
    public Set<Itineraire> getBookings() {
        return bookings;
    }

    public Company bookings(Set<Itineraire> itineraires) {
        this.bookings = itineraires;
        return this;
    }

    public Company addBooking(Itineraire itineraire) {
        this.bookings.add(itineraire);
        itineraire.setCompany(this);
        return this;
    }

    public Company removeBooking(Itineraire itineraire) {
        this.bookings.remove(itineraire);
        itineraire.setCompany(null);
        return this;
    }

    public void setBookings(Set<Itineraire> itineraires) {
        this.bookings = itineraires;
    }
    ...
    public Company configs(Set<CompanyClasse> companyClasses) {
        this.configs = companyClasses;
        return this;
    }

    public Company addConfig(CompanyClasse companyClasse) {
        this.configs.add(companyClasse);
        companyClasse.setCompany(this);
        return this;
    }

    public Company removeConfig(CompanyClasse companyClasse) {
    ...
    public Set<FeesAgency> getConfigs() {
        return configs;
    }

    public Company configs(Set<FeesAgency> feesAgencies) {
        this.configs = feesAgencies;
        return this;
    }

    public Company addConfig(FeesAgency feesAgency) {
        this.configs.add(feesAgency);
        feesAgency.setCompany(this);
        return this;
    }

    public Company removeConfig(FeesAgency feesAgency) {
        this.configs.remove(feesAgency);
        feesAgency.setCompany(null);
        return this;
    }

    public void setConfigs(Set<FeesAgency> feesAgencies) {
        this.configs = feesAgencies;
    }
