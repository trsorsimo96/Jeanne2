...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(ma.maman.jeanne.domain.Company.class.getName() + ".bookings", jcacheConfiguration);
            cm.createCache(ma.maman.jeanne.domain.Company.class.getName() + ".configs", jcacheConfiguration);
            ...
            cm.createCache(ma.maman.jeanne.domain.Day.class.getName() + ".itineraries", jcacheConfiguration);
            ...
            cm.createCache(ma.maman.jeanne.domain.Agency.class.getName() + ".configs", jcacheConfiguration);
            ...
            cm.createCache(ma.maman.jeanne.domain.Classe.class.getName() + ".itineraries", jcacheConfiguration);
            cm.createCache(ma.maman.jeanne.domain.Classe.class.getName() + ".configs", jcacheConfiguration);
            ...
            cm.createCache(ma.maman.jeanne.domain.Routes.class.getName() + ".itineraries", jcacheConfiguration);
